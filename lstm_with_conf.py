...
from src.LSTM_conf import ConfidenceGatedLSTM, LSTM
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_path', type=str, default='dataset/YouTube/processed_with_conf/extracted_labels_Youtube.csv',
